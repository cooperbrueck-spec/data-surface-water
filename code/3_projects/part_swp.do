...
// LOAD EACH COMPONENT DATASET
	...
	import excel using "$DATA_SWP/bulletin_132/B132-25 Tables.xlsx", sheet("Contractors") firstrow clear
	...
	import excel using "$DATA_SWP/bulletin_132/B132-25 Tables.xlsx", sheet("B4") cellrange(A3:AN79) clear
	drop in 2
	...
	import excel using "$DATA_SWP/bulletin_132/B132-25 Tables.xlsx", sheet("B-5B") cellrange(A3:AN79) clear
	drop in 2
	foreach v of varlist A-AN {
		rename `v' v`v'
	}
